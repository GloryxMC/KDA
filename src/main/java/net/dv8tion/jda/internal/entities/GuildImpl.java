...
public class GuildImpl implements Guild
{
    ...
    @NotNull
    @Override
    public AuditableRestAction<RichCustomEmoji> createEmoji(@NotNull String name, @NotNull Icon icon, @NotNull Role... roles)
    {
    ...
    @NotNull
    @Override
    public AuditableRestAction<GuildSticker> createSticker(@NotNull String name, @NotNull String description, @NotNull FileUpload file, @NotNull Collection<String> tags)
    {
        checkPermission(Permission.MANAGE_EMOJIS_AND_STICKERS);
