...
public class MessageBuilder implements Appendable
{
    ...
    /**
     * Adds up to {@value Message#MAX_EMBED_COUNT} {@link MessageEmbed MessageEmbeds} to the Message. Embeds can be built using
     ...
     *         If any of the provided MessageEmbeds is null or not sendable according to {@link MessageEmbed#isSendable() MessageEmbed.isSendable()}!
