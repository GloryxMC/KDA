...
public abstract class GenericGuildStickerUpdateEvent<T> extends GenericGuildStickerEvent implements UpdateEvent<GuildSticker, T>
{
    ...
    public GenericGuildStickerUpdateEvent(@NotNull JDA api, long responseNumber,
                                          @NotNull Guild guild, @NotNull GuildSticker sticker,
                                          @NotNull String identifier, T oldValue, T newValue)
    {
