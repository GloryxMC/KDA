...
{
    public ApplicationUpdatePrivilegesEvent(@NotNull JDA api, long responseNumber, @NotNull Guild guild, long applicationId, @NotNull List<IntegrationPrivilege> privileges)
    {
