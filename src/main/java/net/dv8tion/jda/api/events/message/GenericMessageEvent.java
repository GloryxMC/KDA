...
public abstract class GenericMessageEvent extends Event {
     ...
     * @throws java.lang.IllegalStateException If this was not sent in a channel in a Guild.
     */
    @NotNull
     ...
     * @throws java.lang.IllegalStateException If this was not sent in a {@link net.dv8tion.jda.api.entities.GuildChannel}.
     * @see #isFromGuild()
    ...
    public @Nullable TextChannel getTextChannel() {
        return ExceptionsKt.try_(() -> getGuildChannel().asTextChannel());
    }
    public @Nullable PrivateChannel getPrivateChannel() {
        return ExceptionsKt.try_(() -> getChannel().asPrivateChannel());
    }
}
