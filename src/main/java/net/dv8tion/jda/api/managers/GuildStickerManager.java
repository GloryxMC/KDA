...
public interface GuildStickerManager extends Manager<GuildStickerManager>
{
    ...
    @NotNull
    @CheckReturnValue
    GuildStickerManager setName(@NotNull String name);
    ...
    @NotNull
    @CheckReturnValue
    GuildStickerManager setDescription(@NotNull String description);
    ...
    @NotNull
    @CheckReturnValue
    GuildStickerManager setTags(@NotNull Collection<String> tags);
    ...
    @NotNull
    @CheckReturnValue
    default GuildStickerManager setTags(@NotNull String... tags)
    {
