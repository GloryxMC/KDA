 ...
 *         The different types can be found in the {@link MessageType MessageType} enum.</li>
 *     <li><b>Data Message</b>
 ...
 * </ol>
 *
 * <p>When a feature is not available it will throw an {@link UnsupportedOperationException UnsupportedOperationException}
...
public interface Message extends ISnowflake, Formattable
{
     ...
     *
     * @see MessageAction#addFile(File, AttachmentOption...) MessageAction.addFile(...)
     */
    ...
    */
    ...
    /**
     * Provides the {@link OffsetDateTime OffsetDateTime} defining when this Message was last
    ...
    /**
     * Returns the author of this Message as a {@link Member member}.
     ...
     * {@link IMentionable IMentionable} entities will be resolved to the format
     * shown by the Discord client instead of the {@literal <id>} format.
     *
     * <p>This includes resolving:
     * <br>{@link User Users} / {@link Member Members}
     * to their @Username/@Nickname format,
     * <br>{@link TextChannel TextChannels} to their #ChannelName format,
     * <br>{@link Role Roles} to their @RoleName format
     * <br>{@link Emote Emotes} (not emojis!) to their {@code :name:} format.
     *
    ...
    /**
     * The raw textual content of this message. Does not resolve {@link IMentionable IMentionable}
    ...
    /**
     * Creates an immutable List of {@link Invite Invite} codes
     * that are included in this Message.
     * <br>This will use the {@link Pattern Pattern} provided
     ...
     * {@link Invite#resolve(JDA, String) Invite.resolve(JDA, String)}
     *
     * @throws UnsupportedOperationException
     *         If this is a Data Message (output of {@link MessageBuilder MessageBuilder})
     *
    ...
    /**
     * Used to determine if this Message was received from a {@link MessageChannel MessageChannel}
     * of the {@link ChannelType ChannelType} specified.
     * <br>This will always be false for {@link ChannelType#VOICE} as Messages can't be sent to
     * {@link VoiceChannel VoiceChannels}.
     *
     ...
     *         If this is a Data Message (output of {@link MessageBuilder MessageBuilder})
     *
     * @return True if the {@link ChannelType ChannelType} which this message was received
    ...
    /**
     * Gets the {@link ChannelType ChannelType} that this message was received from.
     * <br>This will never be {@link ChannelType#VOICE} as Messages can't be sent to
     * {@link VoiceChannel VoiceChannels}.
     *
     * @throws UnsupportedOperationException
     *         If this is a Data Message (output of {@link MessageBuilder MessageBuilder})
    ...
    /**
     * Indicates if this Message was sent by a {@link Webhook Webhook} instead of a
     * {@link User User}.
     ...
     *         If this is a Data Message (output of {@link MessageBuilder MessageBuilder})
     *
     * @return True if this message was sent by a {@link Webhook Webhook}.
     */
    boolean isWebhookMessage();

    /**
     * Returns the {@link MessageChannel MessageChannel} that this message was sent in.
     *
     * @throws UnsupportedOperationException
     *         If this is a Data Message (output of {@link MessageBuilder MessageBuilder})
     *
    ...
    /**
     * Returns the {@link GuildMessageChannel GuildMessageChannel} that this message was sent in
    ...
    /**
     * Returns the {@link PrivateChannel PrivateChannel} that this message was sent in.
     * <br><b>This is only valid if the Message was actually sent in a PrivateChannel.</b>
     * <br>You can check the type of channel this message was sent from using {@link #isFromType(ChannelType)} or {@link #getChannelType()}.
     *
     * <p>Use {@link #getChannel()} for an ambiguous {@link MessageChannel MessageChannel}
     * if you do not need functionality specific to {@link PrivateChannel PrivateChannel}.
     *
     * @throws UnsupportedOperationException
     *         If this is a Data Message (output of {@link MessageBuilder MessageBuilder})
     * @throws IllegalStateException
    ...
    /**
     * Returns the {@link TextChannel TextChannel} that this message was sent in.
     * <br><b>This is only valid if the Message was actually sent in a TextChannel.</b>
     * <br>You can check the type of channel this message was sent from using {@link #isFromType(ChannelType)} or {@link #getChannelType()}.
     *
     * <p>Use {@link #getChannel()} for an ambiguous {@link MessageChannel MessageChannel}
     * if you do not need functionality specific to {@link TextChannel TextChannel}.
     *
     * @throws UnsupportedOperationException
     *         If this is a Data Message (output of {@link MessageBuilder MessageBuilder})
     * @throws IllegalStateException
    ...
    /**
     * Returns the {@link NewsChannel NewsChannel} that this message was sent in.
     * <br><b>This is only valid if the Message was actually sent in a NewsChannel.</b>
     * <br>You can check the type of channel this message was sent from using {@link #isFromType(ChannelType)} or {@link #getChannelType()}.
     *
     * <p>Use {@link #getChannel()} for an ambiguous {@link MessageChannel MessageChannel}
     * if you do not need functionality specific to {@link NewsChannel NewsChannel}.
     *
     * @throws UnsupportedOperationException
     *         If this is a Data Message (output of {@link MessageBuilder MessageBuilder})
     * @throws IllegalStateException
     *         If this was not sent in a {@link NewsChannel}.
     *
     ...
     * <br>Equivalent to {@code getTextChannel().getParentCategory()} if this was sent in a {@link TextChannel}.
     *
     * @throws UnsupportedOperationException
     *         If this is a Data Message (output of {@link MessageBuilder MessageBuilder})
     *
     * @return {@link Category Category} for this message
     */
    @Nullable
     ...
     * <br>This is just a shortcut to {@link #getTextChannel()}.{@link TextChannel#getGuild() getGuild()}.
     * <br><b>This is only valid if the Message was actually sent in a TextChannel.</b>
     * <br>You can check the type of channel this message was sent from using {@link #isFromType(ChannelType)} or {@link #getChannelType()}.
     *
     * @throws UnsupportedOperationException
    ...
    /**
     * An immutable list of {@link Attachment Attachments} that are attached to this message.
     * <br>Most likely this will only ever be 1 {@link Attachment Attachment} at most.
     *
     * @throws UnsupportedOperationException
     *         If this is a Data Message (output of {@link MessageBuilder MessageBuilder})
     *
     * @return Immutable list of {@link Attachment Attachments}.
     */
    @NotNull
    List<Attachment> getAttachments();

    /**
     * An immutable list of {@link MessageEmbed MessageEmbeds} that are part of this
     * Message.
     *
     ...
     */
    @Nullable
    default Button getButtonById(@NotNull String id)
    {
     ...
     */
    @NotNull
    default List<Button> getButtonsByLabel(@NotNull String label, boolean ignoreCase)
    {
    ...
    /**
     * A {@link MessageActivity MessageActivity} that contains its type and party id.
     *
     * @throws UnsupportedOperationException
     *         If this is a Data Message (output of {@link MessageBuilder MessageBuilder})
     *
     ...
     *     <br>The edit was attempted after the account lost access to the {@link Guild Guild}
     ...
     *         <br>The {@link Message Message} with the updated content
     */
    @NotNull
    @CheckReturnValue
     ...
     *
     * @return {@link MessageAction MessageAction}
     *         <br>The {@link Message Message} with the updated components
     */
    @NotNull
    @CheckReturnValue
    MessageAction editMessageComponents(@NotNull Collection<? extends LayoutComponent> components);
    ...
    @NotNull
    @CheckReturnValue
    default MessageAction editMessageComponents(@NotNull LayoutComponent... components)
    {
    ...
    /**
     * Edits this Message's content to the provided {@link Message Message}.
     * <br><b>Messages can only be edited by the account that sent them!</b>.
     *
     * <p>This message instance will not be updated by this operation, please use the response message instead.
     *
     ...
     * This behavior can be changed with {@link MessageAction#failOnInvalidReply(boolean)}.
     *
     * <p>For further info, see {@link MessageChannel#sendFile(File, AttachmentOption...)} and {@link MessageAction#reference(Message)}.
     *
     * @param  file
     ...
     * This behavior can be changed with {@link MessageAction#failOnInvalidReply(boolean)}.
     *
     * <p>For further info, see {@link MessageChannel#sendFile(File, String, AttachmentOption...)} and {@link MessageAction#reference(Message)}.
     *
     * @param  data
     ...
     * This behavior can be changed with {@link MessageAction#failOnInvalidReply(boolean)}.
     *
     * <p>For further info, see {@link MessageChannel#sendFile(InputStream, String, AttachmentOption...)} and {@link MessageAction#reference(Message)}.
     *
     * @param  data
     *         The data to upload to the channel in the reply
     * @param  name
     ...
     * This behavior can be changed with {@link MessageAction#failOnInvalidReply(boolean)}.
     *
     * <p>For further info, see {@link MessageChannel#sendFile(byte[], String, AttachmentOption...)} and {@link MessageAction#reference(Message)}.
     *
     * @param  data
     *         The data to upload to the channel in the reply
     * @param  name
     ...
     *
     * @see    TextChannel#deleteMessages(Collection) TextChannel.deleteMessages(Collection)
     * @see    MessageChannel#purgeMessages(List) MessageChannel.purgeMessages(List)
     */
    @NotNull
    @CheckReturnValue
    ...
    /**
     * Returns the {@link JDA JDA} instance related to this Message.
     *
     * @throws UnsupportedOperationException
     *         If this is a Data Message (output of {@link MessageBuilder MessageBuilder})
     *
    ...
    /**
     * Adds a reaction to this Message using an {@link Emote Emote}.
     *
     ...
     *
     * @param  emote
     *         The {@link Emote Emote} to add as a reaction to this Message.
     *
     * @throws UnsupportedOperationException
     *         If this is a Data Message (output of {@link MessageBuilder MessageBuilder})
     * @throws InsufficientPermissionException
     ...
     * @throws IllegalArgumentException
     *         <ul>
     *             <li>If the provided {@link Emote Emote} is null.</li>
     *             <li>If the provided {@link Emote Emote} cannot be used in the current channel.
    ...
    /**
     * Removes a reaction from this Message using an {@link Emote Emote}.
     *
     * <p>This message instance will not be updated by this operation.
     *
     * <p>Reactions are the small emoji/emotes below a message that have a counter beside them
     ...
     *
     * @param  emote
     *         The {@link Emote Emote} to remove as a reaction from this Message.
     *
     * @throws UnsupportedOperationException
     *         If this is a Data Message (output of {@link MessageBuilder MessageBuilder})
     * @throws InsufficientPermissionException
    ...
    /**
     * Removes a {@link User User's} reaction from this Message using an {@link Emote Emote}.
     *
     ...
     *         The {@link Emote Emote} to remove as a reaction from this Message.
     * @param  user
     *         The {@link User User} to remove the reaction for.
     *
     * @throws UnsupportedOperationException
     *         If this is a Data Message (output of {@link MessageBuilder MessageBuilder})
     * @throws InsufficientPermissionException
     ...
     *         {@link Guild Guild}
     *         <b>and</b> the given user is <b>not</b> the {@link SelfUser SelfUser}.</li>
     *     <li>If this message is ephemeral</li>
     * </ul>
     *
     *
    ...
    /**
     * This obtains the {@link User users} who reacted using the given {@link Emote emote}.
     *
     ...
     * @throws IllegalArgumentException
     *         If the provided {@link Emote Emote} is null.
     * @throws IllegalStateException
     *         If this Message is ephemeral
    ...
    /**
     * This obtains the {@link User users} who reacted using the given unicode emoji.
     *
     * <p>Messages maintain a list of reactions, alongside a list of users who added them.
     *
     * <p>Using this data, we can obtain a {@link ReactionPaginationAction ReactionPaginationAction}
    ...
    /**
     * This obtains the {@link MessageReaction MessageReaction} for the given unicode reaction on this message.
     *
     * <p>Messages also store reactions using unicode values.
     *
     * <p>An instance of the related {@link MessageReaction MessageReaction} can be
     ...
     *
     * @return The {@link MessageReaction MessageReaction} of this message or null if not present.
     *
    ...
    @Nullable
    @CheckReturnValue
    MessageReaction getReactionByUnicode(@NotNull String unicode);

    /**
     * This obtains the {@link MessageReaction MessageReaction} for the given reaction id on this message.
     *
    ...
    @Nullable
    @CheckReturnValue
    default MessageReaction getReactionById(@NotNull String id)
    {
     ...
     * @throws IllegalStateException
     *         If this Message is ephemeral
     * @return {@link AuditableRestAction AuditableRestAction} - Type: {@link Void}
     ...
     * {@link MessageFlag#EMBEDS_SUPPRESSED MessageFlag#EMBEDS_SUPPRESSED}
     *
     * @throws UnsupportedOperationException
     *         If this is a Data Message (output of {@link MessageBuilder MessageBuilder})
     *
    ...
    /**
     * Returns an EnumSet of all {@link MessageFlag MessageFlags} present for this Message.
     *
     * @throws UnsupportedOperationException
     *         If this is a Data Message (output of {@link MessageBuilder MessageBuilder})
     *
     * @return Never-Null EnumSet of present {@link MessageFlag MessageFlags}
     *
     * @see    MessageFlag
     */
    @NotNull
    ...
    /**
     * This specifies the {@link MessageType MessageType} of this Message.
     *
     * <p>Messages can represent more than just simple text sent by Users, they can also be special messages that
     * inform about events that occur. Messages can either be {@link MessageType#DEFAULT default messages}
     * or special messages like {@link MessageType#GUILD_MEMBER_JOIN welcome messages}.
     *
     * @throws UnsupportedOperationException
     *         If this is a Data Message (output of {@link MessageBuilder MessageBuilder})
     *
     * @return The {@link MessageType MessageType} of this message.
     */
    @NotNull
    MessageType getType();
     ...
     *         If this is a Data Message (output of {@link MessageBuilder MessageBuilder})
     *
     * @return The {@link Interaction Interaction} of this message.
     */
    @Nullable
    ...
    {
        /**
         * Represents a mention for a {@link User User}/{@link Member Member}
         * <br>The first and only group matches the id of the mention.
         */
        USER("<@!?(\\d+)>", "users"),
        /**
         * Represents a mention for a {@link Role Role}
         * <br>The first and only group matches the id of the mention.
         */
        ROLE("<@&(\\d+)>", "roles"),
        /**
        ...
        CHANNEL("<#(\\d+)>", null),
        /**
         * Represents a mention for a {@link Emote Emote}
         ...
         * <br>It is used internally in methods like {@link MessageAction#allowedMentions(Collection) MessageAction#allowedMentions(Collection)}.
         * <p>
    ...
    enum MessageFlag
    {
         ...
         * @see Message#isSuppressedEmbeds() Message#isSuppressedEmbeds()
         */
        EMBEDS_SUPPRESSED(2),
        /**
    ...
    /**
     * Represents a {@link Message Message} file attachment.
     */
    class Attachment implements ISnowflake
    {
         ...
         * <br><b>The receiver is expected to close the retrieved {@link InputStream}.</b>
         *
         * <h4>Example</h4>
         * <pre>{@code
         ...
         * }</pre>
         *
         * @return {@link CompletableFuture} - Type: {@link InputStream}
         *
         ...
         * <br>This will download the file using the {@link JDA#getCallbackPool() callback pool}.
         ...
         * }</pre>
         *
         * @return {@link CompletableFuture} - Type: {@link File}
         *
        ...
        /**
         * Retrieves the image of this attachment and provides an {@link Icon} equivalent.
         ...
         *
         * @return {@link CompletableFuture} - Type: {@link Icon}
         *
    ...
    /**
     * Represents an {@link net.dv8tion.jda.api.interactions.Interaction Interaction} provided with a {@link Message Message}.
     */
