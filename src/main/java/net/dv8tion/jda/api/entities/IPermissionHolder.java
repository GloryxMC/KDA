...
public interface IPermissionHolder extends ISnowflake
{
     ...
     */
    boolean canSync(@NotNull IPermissionContainer targetChannel, @NotNull IPermissionContainer syncSource);
     ...
     */
    boolean canSync(@NotNull IPermissionContainer channel);
}
